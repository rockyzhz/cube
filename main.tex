...
\tcbset{
    fll/.style={
        ...
        after skip=0pt,
        % frame code={\path[draw=black!70,fill=myblue,rounded corners=5mm,line width=1mm] (frame.south west) rectangle (frame.north east);}
        % interior code={},
        % boxrule=1mm,
...
% \ExplSyntaxOn
% \dim_log:n {\CoffinWidth\TitleCoffin}
% \dim_to_decimal_in_cm:n {\CoffinWidth\TitleCoffin}
% \ExplSyntaxOff

% 把 \NotationCoffin 安装到 \PageOne 里
\JoinCoffins \PageOne [\StepsBoxCoffin-b,\StepsBoxCoffin-l] \NotationCoffin [l,t] (.5em, -1ex)
% \JoinCoffins \PageOne [t,r] \NotationCoffin [l,t] (1em, 0pt)
...
\JoinCoffins \PageOne [r,t] \FLLCoffin [l,t] (.5em, -.8cm)


% 输出 \PageOne 
\TypesetCoffin \PageOne (-2cm,1cm)
\ClearCoffin \PageOne
...
\begin{MultiColsBox}[
    ...
    coffin={PLLCoffin},
    width=\textwidth,
    % width=\linewidth-\CoffinWidth\PageOne-1cm,
    ]
\ExplSyntaxOn
...
\JoinCoffins \PageTwo [\OLLCoffin-l,\OLLCoffin-b] \PLLCoffin [l,t] (0pt, -1ex)


% 输出 \PageTwo 
\TypesetCoffin \PageTwo  (-.8cm,1.5cm)
