...
% % ==================== 预先测量高度 ====================
% % 先用第一个公式来实际测量高度，初始化\gfflheight
% \newsavebox{\gfflmeasurebox}
% \sbox{\gfflmeasurebox}{
...
\begin{tcolorbox}[
    blankest,
    breakable,
    break at=11.2\gfflheight, % 11个公式一页高度（使用实际测量值）
...
\ExplSyntaxOn
\int_zero:N \g_cube_ffl_index_int
...
\begin{tcolorbox}[blankest,height=11.3\gfflheight+2pt,width=\linewidth,halign=center]
    \begin{tcolorbox}[
        enhanced,
        colback=myblue,
        colframe=black!70,
