...
\tcbset{
    fixedheight/.style={
        blankest,height=#1,width=\linewidth,halign=center}} % 11.3\gfllheight+2pt
% endregion
...
% \begin{tcolorbox}[raster columns=3,raster rows=3]
    
% \end{tcolorbox}

% region F2L 公式页面
% ==================== 第1步：一次性生成并自动分页储存 ====================
% 使用实际测量的高度：41个公式，每11个一页，最后一个页面8个公式
\begin{tcolorbox}[pages={11.4\gfllheight}{4}]
\ExplSyntaxOn
...
\begin{tcolorbox}[fixedheight={11\gfllheight}]
    \begin{tcolorbox}[fll={3}]
        % 直接使用储存的4个页面，顶部对齐
...
% region OLL 公式页面
% ==================== 第1步：一次性生成并自动分页储存 ====================
% 使用实际测量的高度：57个公式，每2个一页，最后一个页面8个公式
\begin{tcolorbox}[pages={12.4\gollheight}{5}]
\ExplSyntaxOn
...
% ==================== 第2步：用tabularx属性创建4列布局 ====================
\begin{tcolorbox}[fixedheight={12\gollheight}]
    \begin{tcolorbox}[fll={4}]
        % 直接使用储存的5个页面，顶部对齐
        \useboxarray{1} & \useboxarray{2} & \useboxarray{3} & \useboxarray{4} & \useboxarray{5}
    \end{tcolorbox}
\end{tcolorbox}
% endregion
...
% ==================== 第1步：一次性生成并自动分页储存 ====================
% 使用实际测量的高度：57个公式，每2个一页，最后一个页面8个公式
\begin{tcolorbox}[pages={5.4\gpllheight}{5}]
\ExplSyntaxOn
...
% ==================== 第2步：用tabularx属性创建4列布局 ====================
\begin{tcolorbox}[fixedheight={5\gpllheight}]
    \begin{tcolorbox}[fll={4}]
        % 直接使用储存的5个页面，顶部对齐
        \useboxarray{1} & \useboxarray{2} & \useboxarray{3} & \useboxarray{4} & \useboxarray{5}
    \end{tcolorbox}
