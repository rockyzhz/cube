...
\seq_set_from_clist:Nn \g_cube_pll_all_seq {
    ...
    {-l,-u,-r,-d    }{1=7,3=9}{E} {x'(R\blue{U'}R'\green{D})\\(RUR'\green{D})2\\(R\blue{U'}R'\green{D'})}, % 07
...
\NewCoffin \CrossCoffin
\SetHorizontalCoffin \CrossCoffin {\view{r}\tikz{\Cube{-r--r----}{-b--b----}{-w-www-w-}[\stepsunit]}}
\NewCoffin \FLLCoffin
\SetHorizontalCoffin \FLLCoffin {\tikz{\Cube{---bb}{rr---}{---------}[\stepsunit]}}
\NewCoffin \OLLCoffin
\SetHorizontalCoffin \OLLCoffin {\tikz{\Cube{---bb}{rr---}{yyyyyyyyy}[\stepsunit]}}
\NewCoffin \PLLCoffin
\SetHorizontalCoffin \PLLCoffin {\tikz{\Cube{bbbbb}{rrrrr}{yyyyyyyyy}[\stepsunit]}}

\JoinCoffins \StepsCoffin[hc,vc] \CrossCoffin[l,vc]
\JoinCoffins \StepsCoffin[\CrossCoffin-r,\CrossCoffin-vc] \ShortArrow[l,vc] (\stepsgap,0pt)
\JoinCoffins \StepsCoffin[\ShortArrow-r,\ShortArrow-vc] \FLLCoffin[l,vc] (\stepsgap,0pt)
\JoinCoffins \StepsCoffin[\FLLCoffin-r,\FLLCoffin-vc] \ShortArrow[l,vc] (\stepsgap,0pt)
\JoinCoffins \StepsCoffin[\ShortArrow-r,\ShortArrow-vc] \OLLCoffin[l,vc] (\stepsgap,0pt)
\JoinCoffins \StepsCoffin[\OLLCoffin-r,\OLLCoffin-vc] \ShortArrow[l,vc] (\stepsgap,0pt)
\JoinCoffins \StepsCoffin[\ShortArrow-r,\ShortArrow-vc] \PLLCoffin[l,vc] (\stepsgap,0pt)

\NewCoffin \CrossText
\NewCoffin \FLLText
\NewCoffin \OLLText
\NewCoffin \PLLText
\SetVerticalCoffin \CrossText {2\stepsunit} {
    \centering\sffamily\heiti\LARGE
    \blue{\Huge\bfseries CROSS}\\底层十字}
\SetVerticalCoffin \FLLText {2\stepsunit} {
    \centering\sffamily\heiti\LARGE
    \blue{\Huge\bfseries F2L}\\前两层归位}
\SetVerticalCoffin \OLLText {2\stepsunit} {
    \centering\sffamily\heiti\LARGE
    \blue{\Huge\bfseries OLL}\\最后一层翻色}
\SetVerticalCoffin \PLLText {2\stepsunit} {
    \centering\sffamily\heiti\LARGE
...
\JoinCoffins \StepsCoffin[\CrossCoffin-b,\CrossCoffin-hc] \CrossText[t,hc] (0pt, -5\stepsgap)
\JoinCoffins \StepsCoffin[\FLLCoffin-b,\FLLCoffin-hc] \FLLText[t,hc] (0pt, -5\stepsgap)
\JoinCoffins \StepsCoffin[\OLLCoffin-b,\OLLCoffin-hc] \OLLText[t,hc] (0pt, -5\stepsgap)
\JoinCoffins \StepsCoffin[\PLLCoffin-b,\PLLCoffin-hc] \PLLText[t,hc] (0pt, -5\stepsgap)

\ScaleCoffin \StepsCoffin {0.25} {0.25}
\tcbox[colframe=orange,arc=5mm]{\TypesetCoffin \StepsCoffin}
% endregion
