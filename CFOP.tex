...
\JoinCoffins \TitleCoffin [l,vc] \LogoCoffin [l,vc] (3em,0pt)
...
\SetHorizontalCoffin \CrossStepCoffin {\view{r}\Cube{-r--r----}{-b--b----}{-w-www-w-}[\stepsunit]}
\NewCoffin \FLLStepCoffin
\SetHorizontalCoffin \FLLStepCoffin {\Cube{---bb}{rr---}{---------}[\stepsunit]}
\NewCoffin \OLLStepCoffin
\SetHorizontalCoffin \OLLStepCoffin {\Cube{---bb}{rr---}{yyyyyyyyy}[\stepsunit]}
\NewCoffin \PLLStepCoffin
\SetHorizontalCoffin \PLLStepCoffin {\Cube{bbbbb}{rrrrr}{yyyyyyyyy}[\stepsunit]}
...
\JoinCoffins \PageOne [\LogoCoffin-l,\LogoCoffin-b] \StepsBoxCoffin [l,t] (-2.5em,-1ex)
